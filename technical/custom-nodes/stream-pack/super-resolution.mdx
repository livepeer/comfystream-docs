...
<Tabs>
  ...
  <Tab title="Manual Installation (Advanced)">
    If you prefer to install OpenCV with CUDA support manually, follow the guide on this article: [Installing OpenCV with CUDA Support](https://medium.com/@juancrrn/installing-opencv-4-with-cuda-in-ubuntu-20-04-fde6d6a0a367).
    This guides you through the multiple steps and prerequisites needed to successfully compile OpenCV package.
    
    You can use the code block below as a reference, modify the paths and variables to match your system.
    ...
    After the installation, you can verify that OpenCV is installed correctly by running:
    ```bash
    python3 -c "import cv2; print(cv2.cuda.getCudaEnabledDeviceCount())"
    ```
    This should output `1` or the number of CUDA-enabled devices if installation was successful.
  </Tab>
</Tabs>
...
- Modular design
- Fast performance via CUDA
- Wide suite of supported models
