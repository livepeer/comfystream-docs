...
<Accordion title="Issue connecting to comfystream when using runpod">
   ...
   ```
   Please check the [server settings](/technical/get-started/install#accessing-comfystream) to ensure those allign with the [Stream URL](/technical/get-started/quickstart#comfystream-ui-preview-window) set in the UI.
</Accordion>
