...
If you want to run the workflows in new tab rather than inside of the ComfyUI, you can click **Open ComfyStream UI** from [ComfyStream Menu](install#accessing-comfystream).
