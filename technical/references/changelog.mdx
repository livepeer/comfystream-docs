...
<Update label="July 2025" description="v0.1.3, v0.1.4" tags={["comfystream"]}>
    ...
    - **Updated CUDA Requirements:** Minimum supported NVIDIA CUDA driver version `570.124.06` with `CUDA 12.8`
    - **PyTorch Blackwell Support:** Updated PyTorch for optimal performance on RTX 5090

    ### Infrastructure & Developer Experience
    - **Enhanced Entrypoint Flexibility:** Added `--api` and `--ui` flags to entrypoint.sh for selective service startup
    ...
    ### Base System Updates
    - **CUDA 12.8 and TensorRT 10.12:** Updated base image for improved performance and compatibility
