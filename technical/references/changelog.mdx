...
<Update label="May 2025" description="v0.1.0" tags={["comfystream"]}>
    ...
    ComfyStream v0.1.0 delivers significant enhancements for visual quality and developer flexibility with **multi-resolution support**, an **improved depth mapping model**, and a new **exportable pipeline class** for seamless integration into custom applications. This release is available as Docker images at `livepeer/comfyui-base:v0.1.0` and `livepeer/comfystream:v0.1.0`.
    ...
    - **ComfyUI Registry Updates:** Refreshed logo on ComfyUI Registry

    <Tip>
        **Note:** ComfyStream v0.1.0 requires ComfyUI version 0.3.27 or older due to dependency constraints. [ComfyUI v0.3.27](https://github.com/comfyanonymous/ComfyUI/releases/tag/v0.3.27)
    </Tip>
